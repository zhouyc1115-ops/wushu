  ...
  products: [
    {
      ...
      description: "适合套路练习、演出和比赛展示。Lightweight broad sword for routines, shows and competition display.",
      price: "",
    ...
    },
    {
      ...
      description: "适合竞赛套路与日常训练，刀身轻巧顺手，方便完成快速动作。For competition routines and daily training, light and easy to control.",
      price: "",
      note: "多尺寸可选 / Sizes available",
      tag: "参考商品 / Reference",
      art: "art-broadsword",
    ...
    },
    {
      ...
      description: "适合南拳南刀项目竞赛套路与专项训练，按规格选择尺寸。For Nan Dao routines and dedicated competition training.",
      price: "",
      note: "尺寸选择 / Size",
      tag: "参考商品 / Reference",
      art: "art-broadsword",
    ...
    },
    {
      ...
      description: "适合初学者与进阶套路训练，握感稳定，便于控制剑花与身法。Stable training straight sword for beginners and routine practice.",
      price: "",
    ...
    },
    {
      ...
      description: "适合竞赛套路与表演训练，剑身轻盈，动作表现更利落。Light competition straight sword for sharp routine performance.",
      price: "",
      note: "多尺寸可选 / Sizes available",
      tag: "参考商品 / Reference",
      art: "art-straightsword",
    ...
    },
    {
      ...
      description: "适合基本功、套路与团体训练，提供不同长度选择。For basics, routines and group practice with multiple lengths.",
      price: "",
    ...
    },
    {
      ...
      description: "适合竞赛套路和高频训练，轻巧顺手，便于发力与控制。Standard staff for competition routines and frequent training.",
      price: "",
    ...
    },
    {
      ...
      description: "适合南拳南棍项目训练与比赛，长度选择完整，便于按身高搭配。For Nan Gun training and competition, choose length by height.",
      price: "",
      note: "多长度可选 / Lengths available",
      tag: "参考商品 / Reference",
      art: "art-staff",
    ...
    },
    {
      ...
      description: "适合基础枪术训练和套路练习，长度选择完整，可按身高搭配。Training spear for basics and routines, matched by height.",
      price: "",
      note: "可按身高配 / Match by height",
      tag: "参考商品 / Reference",
      art: "art-staff",
    ...
    },
    {
      ...
      description: "适合竞赛套路与表演训练，轻巧顺手，便于完成枪花与发力动作。Standard spear for competition and performance routines.",
      price: "",
      note: "多长度可选 / Lengths available",
      tag: "参考商品 / Reference",
      art: "art-staff",
    ...
    },
    {
      ...
      description: "适合搭配训练剑、竞赛剑和表演剑，提升器械完整度与舞台效果。Sword tassels for training, competition and stage presentation.",
      price: "",
    ...
    },
    {
      ...
      description: "适合搭配表演刀、竞赛刀，颜色醒目，适合训练与表演。Broad sword flags for training and performance.",
      price: "",
      note: "多色可选 / Colors available",
      tag: "配件 / Accessory",
      art: "art-broadsword",
    ...
    },
    {
      name: "刀剑袋",
      english: "Weapon Bag",
      description: "适合收纳刀、剑等器械，方便训练携带和日常保护。Weapon bag for carrying and protecting swords and other equipment.",
      price: "",
    ...
    },
    {
      ...
      description: "适合武术训练、套路练习与表演场地铺设，可按场地需求咨询。Training mat for wushu practice, routines and performance spaces.",
      price: "",
  ...
  catalogItems: [
    {
      ...
      description: "多色可选，可搭配腰带与队服方案。Multiple colors available, with belt and team uniform options.",
      images: [
    ...
    },
    {
      ...
      description: "适合南拳套路、比赛和舞台表演，可按款式与尺码咨询。For Nanquan routines, competition and stage performance.",
      images: [
    ...
    },
    {
      ...
      description: "适合长拳套路、比赛和舞台表演，可按款式与尺码咨询。For Changquan routines, competition and stage performance.",
      images: [
